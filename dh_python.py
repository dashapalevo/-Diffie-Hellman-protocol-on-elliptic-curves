...
print("Private key A:", hex(alice_private_key))
print("Public key A: (0x{:x}, 0x{:x})".format(*alice_public_key))

# Bob generates his own key pair.
bob_private_key, bob_public_key = make_keypair()
print("Private key B:", hex(bob_private_key))
print("Public key B: (0x{:x}, 0x{:x})".format(*bob_public_key))
